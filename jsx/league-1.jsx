...
var ProgressList = React.createClass({
  getInitialState: function() {
    return {
      productList: [
{classname: "basscss", position: 1, name: "Basscss", floats: 10, uniquecolors: 10, fontsizes: 8, fontfamilies: 3, specificity: 30, mediaqueries: 3, styletags: 0, stylelinks: 1, filesizekb: 14, totalscore: 79, link:(basscssStats) },
{classname: "purecss", position: 2, name: "Pure CSS", floats: 1, uniquecolors: 13, fontsizes: 14, fontfamilies: 7, specificity: 51, mediaqueries: 2, styletags: 0, stylelinks: 1, filesizekb: 18, totalscore: 89, link:(purecssStats) },
{classname: "tachyons", position: 3, name: "Tachyons", floats: 12, uniquecolors: 31, fontsizes: 13, fontfamilies: 12, specificity: 30, mediaqueries: 3, styletags: 0, stylelinks: 1, filesizekb: 40, totalscore: 142, link:(tachyonsStats) },
{classname: "unsplash", position: 4, name: "Unsplash", casestudy: "unsplash.html", floats: 63, uniquecolors: 23, fontsizes: 29, fontfamilies: 7, specificity: 60, mediaqueries: 9, styletags: 0, stylelinks: 1, filesizekb: 114, totalscore: 252, link:(unsplashStats) },
...
{classname: "wikipedia", position: 6, name: "Wikipedia", floats: 4, uniquecolors: 20, fontsizes: 21, fontfamilies: 3, specificity: 210, mediaqueries: 13, styletags: 3, stylelinks: 0, filesizekb: 32, totalscore: 306, link:(wikipediaStats) },
{classname: "bootstrap", position: 7, name: "Bootstrap", floats: 38, uniquecolors: 36, fontsizes: 23, fontfamilies: 7, specificity: 83, mediaqueries: 12, styletags: 0, stylelinks: 1, filesizekb: 111, totalscore: 311, link:(bootstrapStats) },
...
{classname: "csstricks", position: 14, name: "CSS-Tricks", floats: 57, uniquecolors: 52, fontsizes: 49, fontfamilies: 5, specificity: 241, mediaqueries: 6, styletags: 1, stylelinks: 2, filesizekb: 173, totalscore: 559, link:(csstricksStats) },
{classname: "imin", position: 15, name: "Imin", floats: 69, uniquecolors: 55, fontsizes: 45, fontfamilies: 16, specificity: 332, mediaqueries: 7, styletags: 0, stylelinks: 2, filesizekb: 117, totalscore: 643, link:(iminStats) }, 
{classname: "paypal", position: 16, name: "PayPal", floats: 38, uniquecolors: 41, fontsizes: 69, fontfamilies: 29, specificity: 222, mediaqueries: 21, styletags: 1, stylelinks: 1, filesizekb: 244, totalscore: 666, link:(paypalStats) },
{classname: "citypantry", position: 17, name: "Citypantry", floats: 95, uniquecolors: 54, fontsizes: 45, fontfamilies: 13, specificity: 211, mediaqueries: 20, styletags: 0, stylelinks: 2, filesizekb: 245, totalscore: 685, link:(citypantryStats) }, 
{classname: "skyscanner", position: 18, name: "Skyscanner", floats: 100, uniquecolors: 32, fontsizes: 38, fontfamilies: 10, specificity: 322, mediaqueries: 25, styletags: 1, stylelinks: 6, filesizekb: 180, totalscore: 714, link:(skyscannerStats) }, 
{classname: "slack", position: 19, name: "Slack", floats: 31, uniquecolors: 90, fontsizes: 59, fontfamilies: 7, specificity: 311, mediaqueries: 40, styletags: 0, stylelinks: 4, filesizekb: 188, totalscore: 730, link:(slackStats) },
{classname: "imdb", position: 20, name: "IMDB", floats: 124, uniquecolors: 79, fontsizes: 49, fontfamilies: 18, specificity: 312, mediaqueries: 2, styletags: 0, stylelinks: 7, filesizekb: 170, totalscore: 761, link:(imdbStats) },
{classname: "apple", position: 21, name: "Apple", floats: 38, uniquecolors: 16, fontsizes: 32, fontfamilies: 31, specificity: 270, mediaqueries: 44, styletags: 0, stylelinks: 5, filesizekb: 362, totalscore: 798, link:(appleStats) },
{classname: "facebook", position: 22, name: "Facebook", floats: 69, uniquecolors: 53, fontsizes: 27, fontfamilies: 24, specificity: 241, mediaqueries: 4, styletags: 1, stylelinks: 7, filesizekb: 389, totalscore: 815, link:(facebookStats) },
{classname: "yahoo", position: 23, name: "Yahoo", floats: 28, uniquecolors: 140, fontsizes: 72, fontfamilies: 12, specificity: 230, mediaqueries: 20, styletags: 7, stylelinks: 2, filesizekb: 312, totalscore: 823, link:(yahooStats) },
{classname: "airbnb", position: 24, name: "Airbnb", floats: 84, uniquecolors: 43, fontsizes: 50, fontfamilies: 11, specificity: 300, mediaqueries: 17, styletags: 0, stylelinks: 2, filesizekb: 356, totalscore: 863, link:(airbnbStats) },
{classname: "dropbox", position: 25, name: "Dropbox", floats: 37, uniquecolors: 26, fontsizes: 21, fontfamilies: 4, specificity: 510, mediaqueries: 9, styletags: 2, stylelinks: 17, filesizekb: 272, totalscore: 898, link:(dropboxStats) },
{classname: "bbc", position: 26, name: "BBC", floats: 58, uniquecolors: 54, fontsizes: 60, fontfamilies: 18, specificity: 350, mediaqueries: 74, styletags: 1, stylelinks: 6, filesizekb: 288, totalscore: 909, link:(bbcStats) },
{classname: "rightmove", position: 27, name: "Rightmove", floats: 134, uniquecolors: 48, fontsizes: 73, fontfamilies: 11, specificity: 510, mediaqueries: 6, styletags: 0, stylelinks: 2, filesizekb: 166, totalscore: 950, link:(rightmoveStats) },
{classname: "zoopla", position: 28, name: "Zoopla", floats: 227, uniquecolors: 81, fontsizes: 63, fontfamilies: 15, specificity: 300, mediaqueries: 4, styletags: 1, stylelinks: 3, filesizekb: 271, totalscore: 965, link:(zooplaStats) }, 
{classname: "ufc", position: 29, name: "UFC", floats: 141, uniquecolors: 53, fontsizes: 37, fontfamilies: 4, specificity: 510, mediaqueries: 2, styletags: 0, stylelinks: 7, filesizekb: 217, totalscore: 971, link:(ufcStats) },
{classname: "medium", position: 30, name: "Medium", floats: 69, uniquecolors: 51, fontsizes: 57, fontfamilies: 10, specificity: 110, mediaqueries: 35, styletags: 0, stylelinks: 2, filesizekb: 674, totalscore: 1008, link:(mediumStats) },
{classname: "youtube", position: 31, name: "Youtube", floats: 210, uniquecolors: 49, fontsizes: 30, fontfamilies: 4, specificity: 440, mediaqueries: 24, styletags: 1, stylelinks: 4, filesizekb: 441, totalscore: 1093, link:(youtubeStats) },
{classname: "etsy", position: 32, name: "Etsy", floats: 232, uniquecolors: 91, fontsizes: 54, fontfamilies: 18, specificity: 244, mediaqueries: 50, styletags: 1, stylelinks: 5, filesizekb: 507, totalscore: 1202, link:(etsyStats) },
{classname: "dribbble", position: 33, name: "Dribbble", floats: 313, uniquecolors: 51, fontsizes: 41, fontfamilies: 5, specificity: 355, mediaqueries: 49, styletags: 0, stylelinks: 5, filesizekb: 385, totalscore: 1204, link:(dribbbleStats) },
{classname: "twitter", position: 34, name: "Twitter", floats: 280, uniquecolors: 78, fontsizes: 49, fontfamilies: 14, specificity: 202, mediaqueries: 29, styletags: 0, stylelinks: 3, filesizekb: 623, totalscore: 1278, link:(twitterStats) },
{classname: "github", position: 35, name: "Github", floats: 399, uniquecolors: 151, fontsizes: 63, fontfamilies: 17, specificity: 110, mediaqueries: 12, styletags: 0, stylelinks: 4, filesizekb: 534, totalscore: 1290, link:(githubStats) },
{classname: "theguardian", position: 36, name: "The Guardian", floats: 307, uniquecolors: 69, fontsizes: 38, fontfamilies: 16, specificity: 150, mediaqueries: 36, styletags: 8, stylelinks: 3, filesizekb: 697, totalscore: 1324, link:(theguardianStats) },
{classname: "stackoverflow", position: 37, name: "Stack Overflow", floats: 216, uniquecolors: 176, fontsizes: 40, fontfamilies: 9, specificity: 311, mediaqueries: 4, styletags: 0, stylelinks: 1, filesizekb: 600, totalscore: 1357, link:(stackoverflowStats) },
{classname: "streetlife", position: 38, name: "Streetlife", floats: 250, uniquecolors: 68, fontsizes: 47, fontfamilies: 15, specificity: 320, mediaqueries: 18, styletags: 0, stylelinks: 4, filesizekb: 770, totalscore: 1492, link:(streetlifeStats) }, 
{classname: "duedil", position: 39, name: "Duedil", floats: 305, uniquecolors: 199, fontsizes: 68, fontfamilies: 5, specificity: 630, mediaqueries: 33, styletags: 0, stylelinks: 4, filesizekb: 627, totalscore: 1871, link:(duedilStats) }, 
{classname: "signaluk", position: 40, name: "Signal UK", floats: 236, uniquecolors: 125, fontsizes: 75, fontfamilies: 19, specificity: 385, mediaqueries: 53, styletags: 5, stylelinks: 15, filesizekb: 946, totalscore: 1859, link:(signalukStats) }, 
{classname: "pinterest", position: 41, name: "Pinterest", floats: 448, uniquecolors: 127, fontsizes: 76, fontfamilies: 16, specificity: 121, mediaqueries: 33, styletags: 1, stylelinks: 5, filesizekb: 1180, totalscore: 2007, link:(pinterestStats) },
{classname: "kickstarter", position: 42, name: "Kickstarter", floats: 462, uniquecolors: 87, fontsizes: 89, fontfamilies: 23, specificity: 512, mediaqueries: 51, styletags: 0, stylelinks: 1, filesizekb: 991, totalscore: 2016, link:(kickstarterStats) }
      ]
    };
  },
